...
def _build_native_code_prompt(context: dict[str, Any]) -> str:
    return (
        ...
        "later with the frame globals, not the transient exec locals. If installing callbacks, "
        "hooks, or wrappers, bind state through default arguments or store it on a long-lived "
